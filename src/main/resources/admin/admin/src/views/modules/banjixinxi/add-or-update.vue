<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班级编号" prop="banjibianhao">
          <el-input v-model="ruleForm.banjibianhao" 
              placeholder="班级编号" clearable  :readonly="ro.banjibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班级编号" prop="banjibianhao">
              <el-input v-model="ruleForm.banjibianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班级类型" prop="banjileixing">
          <el-input v-model="ruleForm.banjileixing" 
              placeholder="班级类型" clearable  :readonly="ro.banjileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班级类型" prop="banjileixing">
              <el-input v-model="ruleForm.banjileixing" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banjibianhao = true;
          ...
          if(o=='banjileixing'){
            this.ruleForm.banjileixing = obj[o];
	    this.ro.banjileixing = true;
            continue;
          }
          if(o=='banjirenshu'){
